...
class Demo1ApplicationTests {
    ...
    String FIRESTORE_COLLECTION = "https://firestore.googleapis.com/v1/projects/fb-demo-c6774/databases/(default)/documents/users/";
    ...
    void testingFirebase() throws JSONException {
        ...
        jsonObject.put("email", "aytan11khalilova@gmail.com");
        jsonObject.put("password", "Ay12345");
        ...
        assertEquals("John", name.getString("stringValue"));
        assertEquals("Smith", surname.getString("stringValue"));
        assertEquals("345542321", phone.getString("stringValue"));
